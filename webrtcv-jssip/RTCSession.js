  ...
  _createClass(RTCSession, [{
    ...
    value: function answer() {
      ...
      request.reply(200, null, extraHeaders, sdp, function () {
        ...
        _this3._setInvite2xxTimer(request, sdp);
      ...
      //   debugerror(error);
      // });
      console.log('END OF RTCSession ANSWER')
    }
    /**
     * Terminate the call.
     */
    ...
    key: 'respondReinvite',
    value: function respondReinvite(response) {
      ...
      // SAR
      var _this14 = this;
      var replySdp = response || inUseSdp;

      //sendAnswer.call(_this14, replySdp.replace("sendrecv", "inactive"));
      sendAnswer.call(_this14, inUseSdp);
      //console.log('replying...\n', replySdp);

      /*if (response) {
        var optionsa = {
        useUpdate: false,
        rtcOfferConstraints: replySdp
        }
          _this14.renegotiate(options);
      }	*/
      return;
    ...
    value: function _processInDialogSdpOffer(request) {
      ...
      .then(function () {
        ...
        // Passing custom sdp for using Kurento for media
        
        return _this17._rtc.processOffer(e.sdp).catch(function () {
          request.reply(500);
          throw new Error('_createLocalDescription() failed');
        });
      });
    ...
    value: function _sendInitialRequest(mediaConstraints, rtcOfferConstraints, mediaStream) {
      ...
      .then(function () {
        ...
        // pass custom kurento offer here instead
    ...
    value: function _receiveInviteResponse(response) {
      ...
      switch (true) {
        ...
        case /^2[0-9]{2}$/.test(response.status_code):
        {
          ...
          // here again we will have to sdp answer without using RTCsessionDescription

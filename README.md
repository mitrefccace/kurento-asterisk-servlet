...
> sar@MM229445\-PC:~$ node \-v
> 
> v10.3.0
> 
> sar@MM229445\-PC:~$ npm \-v
> 
> 6.1.0
...
First, clone the source code from the [git repository][6] onto your system with:

> `git clone` https://github.com/Sartastic/kurento\-asterisk\-servlet/ desired\-destination\-folder\-name(optional)

Now move into the folder you cloned to, and check the contents as so:

> sar:~/dest\-folder$ ls  
> configuration.js custom\-jssip package.json package\-lock.json [README.md][7] SarIdeasForFutureDevelopment.txt server.js
...
[6]: https://github.com/Sartastic/kurento-asterisk-servlet/
[7]: http://README.md
